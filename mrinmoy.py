...
CHANNEL_ID = '-1002389268537'  # Replace with your specific channel or group ID
# Initialize the bot
...
EXEMPTED_USERS = [6484371402, 6484371402]
...
def bgmi_command(message):
    ...
    try:
        ...
        logging.info(f"Attack started by {user_name}: ./raja {target_ip} {target_port} {default_duration}")
...
if __name__ == "__main__":
    ...
    try:
        ...
        logging.error(f"An error occurred: {e}") e:
